namespace Task_11_1_Forms
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label4.Text = "Введите числа в массив через пробел";
			// 
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(12, 132);
			this.textBox4.Multiline = true;
			this.textBox4.Name = "textBox4";
			this.textBox4.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			this.textBox4.Size = new System.Drawing.Size(394, 143);
			...
			this.button2.Text = "Работа с массивом";
			...
			this.label5.Text = "Скалярное число";
			// 
			// textBox5
			// 
